...
struct NewMedicineFormView: View {
...
//       }
    ...
    @State private var viewModel: MedicineFormViewModel?
    ...
    var body: some View {
        ...
        .onAppear {
            if viewModel == nil {
                viewModel = viewModelCreator.createMedicineFormViewModel(medicineId: medicineId)
            }
