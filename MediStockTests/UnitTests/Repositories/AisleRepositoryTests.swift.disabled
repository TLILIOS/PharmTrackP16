...
final class MockDataServiceAdapterForAisleTests: DataServiceAdapter, @unchecked Sendable {
    ...
    override func adjustStock(medicineId: String, adjustment: Int) async throws -> Medicine {
        throw NSError(domain: "MockAisleTests", code: 0, userInfo: [NSLocalizedDescriptionKey: "Medicine operations not supported in Aisle tests"])
    }
    ...
    override func checkAisleExists(_ aisleId: String) async throws -> Bool {
        return mockAisles.contains { $0.id == aisleId }
    }
