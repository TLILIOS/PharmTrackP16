...
final class MedicineRepositoryTests: XCTestCase {
    ...
    func testMedicineSearchFiltering() async throws {
        ...
        mockDataService.filterPredicate = { $0.name.contains("Doliprane") }
        ...
        mockDataService.filterPredicate = { $0.aisleId == "aisle2" }
        ...
        mockDataService.filterPredicate = { $0.stockStatus == .critical }
        ...
        mockDataService.filterPredicate = { $0.unit == "boîtes" }
    ...
    func testMedicineSortingAndPagination() async throws {
        ...
        mockDataService.sortDescriptor = { $0.sorted(by: { $0.name < $1.name }) }
        ...
        mockDataService.sortDescriptor = { $0.sorted(by: { $0.currentQuantity < $1.currentQuantity }) }
        ...
        mockDataService.sortDescriptor = { $0.sorted(by: { ($0.expiryDate ?? Date.distantFuture) < ($1.expiryDate ?? Date.distantFuture) }) }
